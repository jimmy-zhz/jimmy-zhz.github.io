...
- 使用 `background-color:tomato; color:white; padding:4px; text-shadow: 1px 1px 2px rgba(0,0,0,0.2);font-weight: bold;">选中文本</font>` 格式；
...
示例输入：<s>**示例文本**<s>  
去掉格式后的示例文本：示例文本
重新高亮处理后的示例输出：<font style="background-color:tomato; color:white; padding:4px; text-shadow: 1px 1px 2px rgba(0,0,0,0.2);font-weight: bold;">示例文本</font>
</instruction>
